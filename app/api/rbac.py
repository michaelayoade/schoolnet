...
def list_roles(
    ...
    return service_list_response(
        rbac_service.roles, db, is_active, order_by, order_dir, limit, offset
    )
...
def list_permissions(
    ...
    return service_list_response(
        rbac_service.permissions, db, is_active, order_by, order_dir, limit, offset
    )
